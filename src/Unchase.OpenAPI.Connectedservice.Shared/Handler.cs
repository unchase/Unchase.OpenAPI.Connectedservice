...
namespace Unchase.OpenAPI.ConnectedService
{
        ...
        ConnectedServiceHandler
    {
        ...
        public override async Task<UpdateServiceInstanceResult> UpdateServiceInstanceAsync(
            ConnectedServiceHandlerContext context,
            CancellationToken cancellationToken)
        {
            var instance = (Instance)context.ServiceInstance;
        ...
        private static async Task<BaseCodeGenDescriptor> GenerateCodeAsync(
            ConnectedServiceHandlerContext context,
            Instance instance)
        {
        ...
        private static async Task<BaseCodeGenDescriptor> ReGenerateCodeAsync(
            ConnectedServiceHandlerContext context,
            Instance instance)
        {
            var codeGenDescriptor = await BaseCodeGenDescriptor.CreateAsync<NSwagCodeGenDescriptor>(context, instance);
