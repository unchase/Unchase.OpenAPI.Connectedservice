...
- [x] Update dependencies: add support for NSwag.Commands v13.18.0
...
- [x] Update dependencies: add support for [NSwag.Commands v13.13.2](https://github.com/RicoSuter/NSwag/pull/3592)

## v1.6.4 `(2021-08-05)`

- [x] Update dependencies: add support for [NSwag.Commands v13.13.1](https://github.com/RicoSuter/NSwag/pull/3587)
...
- [x] Update dependencies: add support for [NSwag.Commands v13.12.0](https://github.com/RicoSuter/NSwag/pull/3564)

## v1.6.0 `(2021-06-18)`

- [x] Update dependencies: add support for Visual Studio 2022 preview v1.0

## v1.5.26 `(2021-06-02)`

- [x] Update dependencies: add support for [NSwag.Commands v13.11.3](https://github.com/RicoSuter/NSwag/pull/3500)

## v1.5.25 `(2021-06-02)`

- [x] Update dependencies: add support for [NSwag.Commands v13.11.2](https://github.com/RicoSuter/NSwag/pull/3495)

## v1.5.24 `(2021-05-08)`

- [x] Update dependencies: add support for [NSwag.Commands v13.11.1](https://github.com/RicoSuter/NSwag/pull/3459)

## v1.5.23 `(2021-05-07)`

- [x] Update dependencies: add support for [NSwag.Commands v13.11.0](https://github.com/RicoSuter/NSwag/pull/3456)
...
- [x] Update dependencies: add support for [NSwag.Commands v13.10.9](https://github.com/RicoSuter/NSwag/pull/3402)

## v1.5.18 `(2021-03-08)`

- [x] Update dependencies: add support for [NSwag.Commands v13.10.8](https://github.com/RicoSuter/NSwag/pull/3346)

## v1.5.17 `(2021-02-27)`

- [x] Update dependencies: add support for [NSwag.Commands v13.10.7](https://github.com/RicoSuter/NSwag/pull/3333)

## v1.5.16 `(2021-02-17)`

- [x] Update dependencies: add support for [NSwag.Commands v13.10.6](https://github.com/RicoSuter/NSwag/pull/3327)
- [x] Update dependencies: add support for [NSwag.Commands v13.10.5](https://github.com/RicoSuter/NSwag/pull/3326)
- [x] Update dependencies: add support for [NSwag.Commands v13.10.4](https://github.com/RicoSuter/NSwag/pull/3317)
- [x] Update dependencies: add support for [NSwag.Commands v13.10.3](https://github.com/RicoSuter/NSwag/pull/3305)
...
- [x] Update dependencies: add support for [NSwag.Commands v13.10.0](https://github.com/RicoSuter/NSwag/pull/3251)
  - [x] [CSharp client generator - Implementing Async Pattern on PrepareRequest and ProcessResponse](https://github.com/RicoSuter/NSwag/pull/3248)
- [x] Update dependencies: add support for [NSwag.Commands v13.10.1](https://github.com/RicoSuter/NSwag/pull/3255)

## v1.5.10 `(2020-11-18)`

- [x] Update dependencies: add support for [NSwag.Commands v13.9.3](https://github.com/RicoSuter/NSwag/pull/3176)

## v1.5.9 `(2020-11-14)`

- [x] Update dependencies: add support for [NSwag.Commands v13.9.2](https://github.com/RicoSuter/NSwag/pull/3169)
- [x] Fix [issue #30](https://github.com/unchase/Unchase.OpenAPI.Connectedservice/issues/30)

## v1.5.8 `(2020-11-13)`

- [x] Update dependencies: add support for [NSwag.Commands v13.9.1](https://github.com/RicoSuter/NSwag/pull/3164)

## v1.5.7 `(2020-11-11)`

- [x] Update dependencies: add support for [NSwag.Commands v13.9.0](https://github.com/RicoSuter/NSwag/pull/3157)
  - [x] [Add UseAbortSignal to UI](https://github.com/RicoSuter/NSwag/pull/3101) 

## v1.5.6 `(2020-09-30)`

- [x] Update dependencies: add support for [NSwag.Commands v13.8.2](https://github.com/RicoSuter/NSwag/pull/3084)
